...
print ("spatio-temporal-collisions3:", spatio_temporal_collisions3)
print ("time instants3: ", time_instants3)

#plt.show()'''
'''for i in range (len(time_instants2)):
    ...
    #x_cor3,y_cor3 = oneDtotwoD([robot_plan[time_instants3[i]]], human_trajectory2[time_instants3[i]])
    plt.plot(x_cor, y_cor)
    plt.plot(x_cor2,y_cor2)
    #plt.plot(x_cor3, y_cor3)
...
if (len(spatio_temporal_collisions) == 0):
    ...
    updated_robot_plan = [my_start_index]
    ...
    for i in range (len(temp)):
        updated_robot_plan.append(temp[i])
