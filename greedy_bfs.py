...
def greedy_bfs(start_index, goal_index, width, height, costmap, resolution, origin):#, grid_viz):
    ...
    path_found = False
    print('Greedy BFS: Done with initialization')
    ...
    print('Greedy BFS: Done traversing nodes in open_list')
    ...
    print('Greedy BFS: Done reconstructing path')
    print("lenght : ")
    j = 0
...
if __name__=="__main__":
    ...
    path = greedy_bfs(my_start_index, my_goal_index, my_width,my_height, my_costmap, my_resolution, my_origin)
    print("path =  \n", path)
